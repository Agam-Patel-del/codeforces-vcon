...
* **Historical Baseline (All-Time Average):**
  The mean performance rating across all your recorded virtual and unrated contests:
  $$\overline{R}_{\text{all-time}} = \frac{\sum_{i=1}^{N} R_{\text{perf}, i}}{N}$$

* **Recent Form (Last 5 Average):**
  The mean performance rating across your 5 most recent contests:
  $$\overline{R}_{\text{last 5}} = \frac{\sum_{i=1}^{5} R_{\text{perf}, i}}{5}$$
